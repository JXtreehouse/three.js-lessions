/*
 * @Author: your name
 * @Date: 2021-03-16 19:43:32
 * @LastEditTime: 2021-03-16 19:43:33
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /three.js-lessions/教程/lib/js/utils/SkeletonUtils.js
 */
import {
    AnimationClip,
    AnimationMixer,
...
var SkeletonUtils = {
    retarget: (function () {
        ...
        return function (target, source, options) {
            ...
            options.preserveMatrix =
                options.preserveMatrix !== undefined
                    ? options.preserveMatrix
                    : true;
            ...
            options.useTargetMatrix =
                options.useTargetMatrix !== undefined
                    ? options.useTargetMatrix
                    : false;
            ...
            for (i = 0; i < bones.length; ++i) {
                ...
                if (boneTo && name !== options.hip) {
                    var boneParent = this.getNearestBone(bone.parent, nameKeys),
                        boneToParent = this.getNearestBone(
                            boneTo.parent,
                            nameValues
                        );
                    ...
                    targetParentPos.setFromMatrixPosition(
                        boneParent.matrixWorld
                    );
                    targetPos.setFromMatrixPosition(bone.matrixWorld);

                    sourceParentPos.setFromMatrixPosition(
                        boneToParent.matrixWorld
                    );
    ...
    getBoneByName: function (name, skeleton) {
        for (
            var i = 0, bones = this.getBones(skeleton);
            i < bones.length;
            i++
        ) {
